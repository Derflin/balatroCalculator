...
#       m_add_mult = Int/String{ "joker_count", "deck_below_default_count", "dollar_count_div_five", "left_jokers_sell_value", "held_queen_count", "held_lowest_rank", "played_hand_count" },
...
JOKERS = [
    ...
    {"id": 1, "name": "Greedy Joker", "copy_compat": True, "rarity": JOKER_RARITY_STID["common"], "cost": 5, "effect_active": {"b_add_mult": 4}, "scoring_order": GAME_SCORING_ORDER_STID["played_hand"], "condition": {"card_suit": [CARD_SUIT_STID["D"]]}},
    {"id": 2, "name": "Lusty Joker", "copy_compat": True, "rarity": JOKER_RARITY_STID["common"], "cost": 5, "effect_active": {"b_add_mult": 4}, "scoring_order": GAME_SCORING_ORDER_STID["played_hand"], "condition": {"card_suit": [CARD_SUIT_STID["H"]]}},
    {"id": 3, "name": "Wrathful Joker", "copy_compat": True, "rarity": JOKER_RARITY_STID["common"], "cost": 5, "effect_active": {"b_add_mult": 4}, "scoring_order": GAME_SCORING_ORDER_STID["played_hand"], "condition": {"card_suit": [CARD_SUIT_STID["S"]]}},
    {"id": 4, "name": "Gluttonous Joker", "copy_compat": True, "rarity": JOKER_RARITY_STID["common"], "cost": 5, "effect_active": {"b_add_mult": 4}, "scoring_order": GAME_SCORING_ORDER_STID["played_hand"], "condition": {"card_suit": [CARD_SUIT_STID["C"]]}},
    ...
    {"id": 7, "name": "Mad Joker", "copy_compat": True, "rarity": JOKER_RARITY_STID["common"], "cost": 4, "effect_active": {"b_add_mult": 20}, "scoring_order": GAME_SCORING_ORDER_STID["owned_jokers"], "condition": {"played_hand_contain_type": POKER_HANDS_STID["four_of_kind"]}},
    ...
    {"id": 12, "name": "Clever Joker", "copy_compat": True, "rarity": JOKER_RARITY_STID["common"], "cost": 4, "effect_active": {"b_add_chip": 150}, "scoring_order": GAME_SCORING_ORDER_STID["owned_jokers"], "condition": {"played_hand_contain_type": POKER_HANDS_STID["four_of_kind"]}},
    ...
    {"id": 30, "name": "Fibonacci", "copy_compat": True, "rarity": JOKER_RARITY_STID["uncommon"], "cost": 7, "effect_active": {"b_add_mult": 8}, "scoring_order": GAME_SCORING_ORDER_STID["played_hand"], "condition": {"card_rank": [CARD_RANK_STID["2"], CARD_RANK_STID["3"], CARD_RANK_STID["5"], CARD_RANK_STID["8"]]}},
    {"id": 31, "name": "Steel Joker", "copy_compat": True, "rarity": JOKER_RARITY_STID["uncommon"], "cost": 7, "effect_active": {"b_mul_mult": 0.25, "m_mul_mult": "steel_card_deck_count", "a_mul_mult": 1.0}, "scoring_order": GAME_SCORING_ORDER_STID["owned_jokers"]},
    ...
    {"id": 39, "name": "Odd Todd", "copy_compat": True, "rarity": JOKER_RARITY_STID["common"], "cost": 4, "effect_active": {"b_add_chip": 30}, "scoring_order": GAME_SCORING_ORDER_STID["played_hand"], "condition": {"card_rank": [CARD_RANK_STID["3"], CARD_RANK_STID["5"], CARD_RANK_STID["7"], CARD_RANK_STID["9"], CARD_RANK_STID["A"]]}},
    ...
    {"id": 48, "name": "Runner", "copy_compat": True, "rarity": JOKER_RARITY_STID["common"], "cost": 5, "effect_active": {"b_add_chip": 10, "m_add_chip": 0, "a_add_chip": 20}, "scoring_order": GAME_SCORING_ORDER_STID["owned_jokers"], "upgrade": {"effect_active": {"m_add_chip": 1}}},
    ...
    {"id": 53, "name": "Sixth Sense", "affect_scoring": False, "copy_compat": False, "rarity": JOKER_RARITY_STID["rare"], "cost": 6, "scoring_order": None},
    ...
    {"id": 50, "name": "Cavendish", "copy_compat": True, "rarity": JOKER_RARITY_STID["common"], "cost": 4, "effect_active": {"b_mul_mult": 3}, "scoring_order": GAME_SCORING_ORDER_STID["owned_jokers"]},
    ...
    {"id": 64, "name": "Square Joker", "copy_compat": True, "rarity": JOKER_RARITY_STID["common"], "cost": 5, "effect_active": {"b_add_chip": 4, "m_add_chip": 0, "a_add_chip": 16}, "scoring_order": GAME_SCORING_ORDER_STID["owned_jokers"], "upgrade": {"effect_active": {"m_add_chip": 1}}},
    {"id": 65, "name": "Seance", "affect_scoring": False, "copy_compat": True, "rarity": JOKER_RARITY_STID["rare"], "cost": 7, "scoring_order": None},
    {"id": 66, "name": "Riff-Raff", "affect_scoring": False, "copy_compat": True, "rarity": JOKER_RARITY_STID["common"], "cost": 4, "scoring_order": None},
    {"id": 67, "name": "Vampire", "copy_compat": True, "rarity": JOKER_RARITY_STID["uncommon"], "cost": 7, "effect_active": {"b_mul_mult": 0.2, "m_mul_mult": 0, "a_mul_mult": 1.0}, "effect_passive": {"removes_enhancements": True}, "scoring_order": GAME_SCORING_ORDER_STID["owned_jokers"], "upgrade": {"effect_active": {"m_mul_mult": 1}}},
    ...
    {"id": 70, "name": "Vagabond", "affect_scoring": False, "copy_compat": True, "rarity": JOKER_RARITY_STID["uncommon"], "cost": 6, "scoring_order": None},
    ...
    {"id": 72, "name": "Cloud 9", "affect_scoring": False, "copy_compat": False, "rarity": JOKER_RARITY_STID["uncommon"], "cost": 6, "scoring_order": None},
    ...
    {"id": 75, "name": "Midas Mask", "affect_scoring": False, "copy_compat": False, "rarity": JOKER_RARITY_STID["uncommon"], "cost": 6, "effect_passive": {"face_cards_to_gold": True}, "scoring_order": None, "condition": {"card_rank": [CARD_RANK_STID["J"], CARD_RANK_STID["Q"], CARD_RANK_STID["K"]]}},
    ...
    {"id": 81, "name": "Reserved Parking", "affect_scoring": False, "copy_compat": True, "rarity": JOKER_RARITY_STID["uncommon"], "cost": 6, "scoring_order": None},
    ...
    {"id": 90, "name": "Lucky Cat", "copy_compat": True, "rarity": JOKER_RARITY_STID["uncommon"], "cost": 6, "effect_active": {"b_mul_mult": 0.2, "m_mul_mult": 0, "a_mul_mult": 1.0}, "scoring_order": GAME_SCORING_ORDER_STID["owned_jokers"], "upgrade": {"effect_active": {"m_mul_mult": 1}}},
    ...
    {"id": 94, "name": "Trading Card", "affect_scoring": False, "copy_compat": False, "rarity": JOKER_RARITY_STID["uncommon"], "cost": 5, "scoring_order": None},
    ...
    {"id": 103, "name": "Smiley Face", "copy_compat": True, "rarity": JOKER_RARITY_STID["common"], "cost": 4, "effect_active": {"b_add_mult": 4}, "scoring_order": GAME_SCORING_ORDER_STID["played_hand"], "condition": {"card_rank": [CARD_RANK_STID["J"], CARD_RANK_STID["Q"], CARD_RANK_STID["K"]]}},
    {"id": 104, "name": "Campfire", "copy_compat": True, "rarity": JOKER_RARITY_STID["rare"], "cost": 9, "effect_active": {"b_mul_mult": 0.5, "m_mul_mult": 0, "a_mul_mult": 1.0}, "scoring_order": GAME_SCORING_ORDER_STID["owned_jokers"], "upgrade": {"effect_active": {"m_mul_mult": 1}}},
    ...
    {"id": 109, "name": "Swashbuckler", "copy_compat": True, "rarity": JOKER_RARITY_STID["common"], "cost": 4, "effect_active": {"b_add_mult": 1, "m_add_mult": "left_jokers_sell_value"}, "scoring_order": GAME_SCORING_ORDER_STID["owned_jokers"]},
    ...
    {"id": 114, "name": "Hanging Chad", "copy_compat": True, "rarity": JOKER_RARITY_STID["common"], "cost": 4, "effect_active": {"a_trigger": 1}, "scoring_order": GAME_SCORING_ORDER_STID["played_hand"], "condition": {"trigger_once": True}},
    {"id": 115, "name": "Rough Gem", "affect_scoring": False, "copy_compat": True, "rarity": JOKER_RARITY_STID["uncommon"], "cost": 7, "scoring_order": None},
    {"id": 116, "name": "Bloodstone", "copy_compat": True, "rarity": JOKER_RARITY_STID["uncommon"], "cost": 7, "effect_active": {"b_mul_mult": 2.0}, "scoring_order": GAME_SCORING_ORDER_STID["played_hand"], "condition": {"card_suit": [CARD_SUIT_STID["H"]], "activate_probability": 1.0/3.0}},
    ...
    {"id": 118, "name": "Onyx Agate", "copy_compat": True, "rarity": JOKER_RARITY_STID["uncommon"], "cost": 7, "effect_active": {"b_add_mult": 8}, "scoring_order": GAME_SCORING_ORDER_STID["played_hand"], "condition": {"card_suit": [CARD_SUIT_STID["C"]]}},
    {"id": 119, "name": "Glass Joker", "copy_compat": True, "rarity": JOKER_RARITY_STID["uncommon"], "cost": 6, "effect_active": {"b_mul_mult": 0.5, "m_mul_mult": 0, "a_mul_mult": 1.0}, "scoring_order": GAME_SCORING_ORDER_STID["owned_jokers"], "upgrade": {"effect_active": {"m_mul_mult": 1}}},
    ...
    {"id": 123, "name": "Wee Joker", "copy_compat": True, "rarity": JOKER_RARITY_STID["rare"], "cost": 8, "effect_active": {"b_add_chip": 8, "m_add_chip": 0, "a_add_chip": 10}, "scoring_order": GAME_SCORING_ORDER_STID["owned_jokers"], "upgrade": {"effect_active": {"m_add_chip": 1}}},
    ...
    {"id": 135, "name": "The Stuntman", "copy_compat": True, "rarity": JOKER_RARITY_STID["uncommon"], "cost": 6, "effect_active": {"b_add_chip": 300}, "scoring_order": GAME_SCORING_ORDER_STID["owned_jokers"]},
    {"id": 136, "name": "Invisible Joker", "affect_scoring": False, "rarity": JOKER_RARITY_STID["rare"], "cost": 10, "scoring_order": None},
    ...
    {"id": 143, "name": "Burnt Joker", "affect_scoring": False, "copy_compat": True, "rarity": JOKER_RARITY_STID["uncommon"], "cost": 6, "scoring_order": None},
    ...
    {"id": 147, "name": "Yorick", "copy_compat": True, "rarity": JOKER_RARITY_STID["legendary"], "cost": 20, "effect_active": {"b_mul_mult": 5.0}, "scoring_order": GAME_SCORING_ORDER_STID["owned_jokers"]},
